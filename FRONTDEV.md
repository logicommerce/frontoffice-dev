...
This is a manual setup of Dev Container template. The recommended way to work with this template now is to use the [**Logicommerce Studio** VS Code extension](README.md).
...
- projects/
  - lc/
    - fwk/         <- 'git clone https://github.com/logicommerce/framework-php.git fwk'
...
var_dump('Studio environment credentials are required.');
exit;
